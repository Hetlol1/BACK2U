...
-- ------------------------------------------------------------
-- Table: allowed_domains  (for college domain login system)
-- ------------------------------------------------------------
...
INSERT INTO `allowed_domains` (`domain`, `college`, `approved`) VALUES
('nmims.edu',         'NMIMS',            1),
('nmims.in',          'NMIMS',            1),
...
('Admin', 'admin@nmims.edu', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin');
